...
?>
  ...
  <?php include 'sidebar.php'; ?>
	...
	?>
						<tr>
            <form method="post" action="outlet_order.php?action=add&prod_code=<?php echo $product_array[$key]["prod_code"]; ?>">
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td style="text-align:center;"><a href="outlet_order.php?action=remove&prod_code=<?php echo $item["prod_code"]; ?>" class="btn btn-danger btn-sm" ><i class="fa fa-trash"></i></a></td>
				</tr>
				<?php
...
?>
      ...
      <a class="btn btn-warning" href="outlet_order.php?action=empty">Empty Cart</a>
			<a class="btn btn-success" href="outlet_order.php?action=checkout">Checkout</a>
      	</form>
